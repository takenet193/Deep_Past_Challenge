...
promoted_to: note_quality_network_links_20260104235020
promoted_at: 2026-01-04
---

# アフォリズム: note quality from network of links
...
- ノートの価値は「中身」だけでなく、リンク/バックリンクのネットワーク内での位置づけから生まれる
- 未接続のノートは“沈む”／再発見は偶然性に依存する、という設計思想はZettelkasten運用の規律になる
